(()=>{
  const directSources={};
  const b64Sources={
    'Stanley Aerolight':'/assets/stanley-aerolight-black-v23.b64',
  ...
  function applyOne(name,src){
    ...
    if(modalName===name&&modalImg&&imgDifferent(modalImg,src)){
      modalImg.src=src;
  ...
  function imgDifferent(img,src){return img.getAttribute('src')!==src;}
